...
```mermaid
graph TD
    AKR[AKR Brand Guidelines] --> Strategy[01. Strategy]
    AKR --> Identity[02. Identity]
    AKR --> Guidelines[03. Design Guidelines & Rules]

    Strategy --> S1[01. Index & Overview]
    Strategy --> S2[02. Brand Identity]
    Strategy --> S3[03. Colour System]
    Strategy --> S4[04. Palette & Tokens]
    Strategy --> S5[05. Brand Rules]

    Identity --> I1[06. Grid Layouts]
    Identity --> I2[07. Layout Systems]
    Identity --> I3[08. Fonts & Assets]
    Identity --> I4[09. Type Hierarchy]
    Identity --> I5[10. Reference Designs]

    Guidelines --> G1[11. Applications]
    Guidelines --> G2[12. Visual Mockups]
    Guidelines --> G3[13. UI Components]
    Guidelines --> G4[14. System Tokens]
    Guidelines --> G5[15. Logo Assets]
    Guidelines --> G6[16. Brand Graphics]
    Guidelines --> G7[17. Guidelines Summary]
    Guidelines --> G8[18. Final Specifications]
```
